...
namespace GBSforDynamo
{
    ...
    [NodeCategory("GBSforDynamo.EnergySettings")]
    ...
    [NodeCategory("GBSforDynamo.EnergySettings")]
    [NodeDescription("Select an Operating Schedule to use with the GBSforDynamo Energy Settings node.")]
    [IsDesignScriptCompatible]
    ...
    [NodeCategory("GBSforDynamo.EnergySettings")]
    [NodeDescription("Select a Conceptual Construction Type to use with the GBSforDynamo Set Surface Parameters node.")]
    [IsDesignScriptCompatible]
    ...
    [NodeCategory("GBSforDynamo.EnergySettings")]
    [NodeDescription("Select a Space Type to use with the GBSforDynamo Set Zone Parameters node.")]
    [IsDesignScriptCompatible]
    ...
    [NodeCategory("GBSforDynamo.EnergySettings")]
    [NodeDescription("Select a Condition Type to use with the GBSforDynamo Set Zone Parameters node.")]
    [IsDesignScriptCompatible]
